...
<NutmegCover category="NUTMEG Slide Design System" title="伝える内容を、迷わず整える" updated="v0.4.0" :presenter="{ name: 'NUTMEG Design Team', url: 'https://github.com/hiro-to/nutmeg-slidev' }" /> <!-- x-release-please-version -->
